...
{
	define("ADMIN_EDIT_ICON", "<img src='".e_IMAGE_ABS."admin/edit_16.png' alt='' title='".LAN_EDIT."' style='border:0px; height:16px; width:16px' />");
	define("ADMIN_EDIT_ICON_PATH", e_IMAGE."admin/edit_16.png");
}
...
{
	define("ADMIN_DELETE_ICON", "<img src='".e_IMAGE_ABS."admin/delete_16.png' alt='' title='".LAN_DELETE."' style='border:0px; height:16px; width:16px' />");
	define("ADMIN_DELETE_ICON_PATH", e_IMAGE."admin/delete_16.png");
}

if (!defined('ADMIN_WARNING_ICON'))
{
	define("ADMIN_WARNING_ICON", "<img src='".e_IMAGE_ABS."admin/nopreview.png' alt='' title='".LAN_WARNING."' style='border:0px' />");
	define("ADMIN_WARNING_ICON_PATH", e_IMAGE."admin/nopreview.png");
}
...
if (strpos(e_SELF.'?'.e_QUERY, 'menus.php?configure') === FALSE && isset($pref['admincss']) && $pref['admincss'] && file_exists(e_THEME.'css/'.$pref['admincss'])) {
	$css_file = file_exists(THEME_ABS.'admin_'.$pref['admincss']) ? THEME_ABS.'admin_'.$pref['admincss'] : e_THEME.'css/'.$pref['admincss'];
	echo "<link rel='stylesheet' href='".$css_file."' type='text/css' />\n";
	
} 
else if (isset($pref['themecss']) && $pref['themecss'] && file_exists(THEME.$pref['themecss']))
{
	$css_file = file_exists(e_THEME.'css/admin_'.$pref['themecss']) ? e_THEME.'css/admin_'.$pref['themecss'] : THEME_ABS.$pref['themecss'];
	echo "<link rel='stylesheet' href='".$css_file."' type='text/css' />\n";
