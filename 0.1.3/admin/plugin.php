	...
	//Unset any possible eplug_ variables set by last plugin.php
		...
		// See whether plugin needs install - it does if any of the 'configuration' variables are set
 		if ($eplug_conffile || is_array($eplug_table_names) || is_array($eplug_prefs) || is_array($eplug_array_pref) || is_array($eplug_user_prefs) || is_array($eplug_sc) || is_array($eplug_bb) || $eplug_module || $eplug_userclass || $eplug_status || $eplug_latest) {
			$img = (!$plug['plugin_installflag'] ? "<img src='".e_IMAGE."admin/uninstalled.png' alt='' />" : "<img src='".e_IMAGE."admin/installed.png' alt='' />");
		} else {
			$img = "<img src='".e_IMAGE."admin/noinstall.png' alt='' />";
		}

		if ($plug['plugin_version'] != $eplug_version && $plug['plugin_installflag']) {
			$img = "<img src='".e_IMAGE."admin/upgrade.png' alt='' />";
		}
...
$text .= "</table>
	...
	<img src='".e_IMAGE."admin/uninstalled.png' alt='' /> ".EPL_ADLAN_23."&nbsp;&nbsp;
	<img src='".e_IMAGE."admin/installed.png' alt='' /> ".EPL_ADLAN_22."&nbsp;&nbsp;
	<img src='".e_IMAGE."admin/upgrade.png' alt='' /> ".EPL_ADLAN_24."&nbsp;&nbsp;
	<img src='".e_IMAGE."admin/noinstall.png' alt='' /> ".EPL_ADLAN_25."</div></div>";
