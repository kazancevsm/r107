...
define("lan_add_button_1", "Растянуть по ширине: [justify]Этот текст будет растянут по ширине[/justify]");
define("lan_add_button_2", "Обтекание картинки текстом справа: [img class=wrapright] установи курсор после слова img и нажми кнопку wrapright");
define("lan_add_button_3", "Вставить буквицу: [bukvica]Этот символ будет буквицей[/bukvica]");
