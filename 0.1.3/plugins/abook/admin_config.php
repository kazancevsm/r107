...
if (IsSet($_POST['submit_edit'])){
	if ($cat_id == ''){ $message = "<font color=red>".AB_MES_01."</font>";
...
if (IsSet($_POST['submit_insert'])){
	if ($cat_name == ""){ 
		$message = "<font color=red>".AB_MES_04."</font>";
	}
	else {
		$sql = new db;
		$sql -> db_Insert("ab_cat", "0,'$cat_name', '$cat_desc', '$cat_icon'");
	$message = "<font color=red>".AB_MES_05."</font>";
...
//======Update_notes======//	
	...
	$sql -> db_Update("ab_cat", " cat_name='$cat_name', cat_desc='$cat_desc', cat_icon='$cat_icon' WHERE cat_id='$cat_id'");
		$message = "<font color=red>".AB_MES_06."</font>";
		$ns -> tablerender(AB_MES_00, $message);
	$cat_id=$cat_name=$cat_desc=$cat_icon='';
	$vis = 'none';
	$unvis = 'yes';
...
//========================================form select============================
	$text ="<form name='form_select_cat' method='post' action=''><table class='fborder' width='100%'>";
        $text .= "<tr><td class='forumheader3' width='30%'>".AB_CAT_MENU."</td><td class='forumheader3' width='70%'><select class='tbox' name='cat_id'><option value=''>".AB_CAT_SEL."";
	...
	<input type='submit' class='button' style='cursor:pointer;' value=".AB_BUT_EDIT." name='submit_edit'>
	<input type='submit' class='button' style='cursor:pointer;' value=".AB_BUT_DEL." name='submit_delete' onclick='return confirmDeleteCat();'></td></tr>";
	$text .="</table></form>";
$caption = AB_CAT_CAP;
$ns -> tablerender($caption, $text);
//=============================form new category=================================
	$text ="<form name='insert_cat' enctype='multipart/form-data' method='post' action=''><table class='fborder' style='width:100%'>";
	$text .= "<tr><td class='forumheader3' width='30%'>".AB_CAT_NAME."</td>
	...
	$text .= "<tr><td class='forumheader3' width='30%'>".AB_CAT_DESC."</td><td class='forumheader3' width='70%'><input class='tbox' type='text' name='cat_desc' value='$cat_desc' size='60'></td></tr>";
//===============================select cat_icon=================================
        $fl = new e_file;
if($iconlist = $fl->get_files(e_PLUGIN."abook/theme/icons_cat/", ".jpg|.gif|.png|.JPG|.GIF|.PNG")){
	...
	$text .= "<tr>
		<td style='width:30%' class='forumheader3'>".AB_IMG_02." </td>
		...
		<input type ='button' class='button' style='cursor:pointer' size='30' value='".AB_IMG_03."' onclick='expandit(this)' />
	...
	$text .= "<tr><td class='forumheader'></td><td class='forumheader'>
		<input type='submit' class='button' style='cursor:pointer;display:$unvis' value=".AB_BUT_AGR." name='submit_insert'>
		<input type='submit' class='button' style='cursor:pointer;display:$vis' value=".AB_BUT_UPD." name='submit_update'>
		<input type='submit' class='button' style='cursor:pointer;display:$vis' value=".AB_BUT_CANS." name='submit_reset'>
		</td></tr></table></form>";
$caption = AB_CAT_EDIT;
$ns -> tablerender($caption, $text);
...
//===================form check, edit or delete of new notice====================
		$text .="<form  method='post' enctype='multipart/form-data' name='form_select_new' id='form_select' action=''>
			...
			<td class='fcaption'>".AB_MAN_ORG_NEW." <select class='tbox' name='gnl_id'>";
			$sql -> db_Select("ab_gnl", "*", "gnl_check_admin='".AB_SEL_NO."'");
				while($row = $sql -> db_Fetch()){
					$gnlId = $row['gnl_id'];
...
//===================form check, edit or delete of old notice====================
		$text .="<form  method='post' enctype='multipart/form-data' name='form_select_old' id='form_select' action=''>
			<table class='border' style='width:100%' align='center'>
			<td class='fcaption'>".AB_MAN_ORG_OLD." <select class='tbox' name='gnl_id'>";
			$sql -> db_Select("ab_gnl", "*", "gnl_check_admin='".AB_SEL_YES."'");
				while($row = $sql -> db_Fetch()){
					$gnlId = $row['gnl_id'];
					$gnlName=$row['gnl_name'];
				$text .="<option value='$gnlId'>$gnlName</option>";
...
<table><tr><td><img src='images/img_abook.png' alt='".AB_ALT_1."'></td><td>".AB_MAN_PR1."</td></tr></table>";
...
$text .="<table>";
	...
	$text .="<tr><td>".AB_ADD_name." *</td><td><input class='tbox' type='text' name='gnl_name' oablur='checkname()' size='50' value='$gnl_name' maxlength='200'/><span id='check_name'></span></td>";

	$text .="<tr><td>".AB_ADD_mag."</td><td><input class='tbox' type='text' name='gnl_mag' size='50' value='$gnl_mag' maxlength='200'/></td>";

	$text .="<tr><td>".AB_ADD_city." *</td><td><input class='tbox' type='text' name='gnl_city' oablur='checkcity()' size='50' value='$gnl_city' maxlength='200'/><span id='check_city'></span></td>";

	$text .="<tr><td>".AB_ADD_address." *</td><td><input class='tbox' type='text' name='gnl_address' oablur='checkaddress()' size='50' value='$gnl_address' maxlength='200'/><span id='check_address'></span></td>";
...
//	$text .="<tr><td>".AB_cat."</td><td><input class='tbox' type='text' name='gnl_cat' size='50' value='$gnl_cat' maxlength='200'/></td>";
	...
	$text .="<tr><td>".AB_ADD_conname." *</td><td><input class='tbox' type='text' name='gnl_conname' oablur='checkconname()' size='50' value='$gnl_conname' maxlength='200'/><span id='check_conname'></span></td>";

	$text .="<tr><td>".AB_ADD_conphone." *</td><td><input class='tbox' type='text' name='gnl_conphone' oablur='checkconphone()' size='50' value='$gnl_conphone' maxlength='200'/><span id='check_conphone'></span></td>";
...
//	$text .= "<tr><td>".AB_ADD_img."</td>	<td><input class='tbox' name='file_userfile[]' type='file' size='30'></td></tr>";
	...
	$text .="<tr><td>".AB_ADD_devision." *</td><td><textarea cols=48 rows=10 class='tbox' type='text' name='gnl_devision' oablur='checkdevision()' maxlength='500'/>$gnl_devision</textarea><span id='check_devision'></span></td>";
	...
	$text .="<tr><td>".AB_check_admin."</td><td><select class='tbox' name='gnl_check_admin'>";
				$text .="<option value='$gnl_check_admin'>$gnl_check_admin</option>";
				$text .="<option value=".AB_SEL_YES.">".AB_SEL_YES."</option>";
				$text .="<option value=".AB_SEL_NO.">".AB_SEL_NO."</option>";
	$text .="</select></td>";
...
if(IsSet($_POST['savesettings'])){
	...
	$text .="<form enctype='multipart/form-data' name='form_config' method='post' action=''><table class='fborder' style='width:100%' align='center'>";
        $text .= "<tr><td class='forumheader3' width='60%'>".AB_CONF_01."</td><td class='forumheader3'><input class='tbox' size='40' type='text' name='ab_admail' value='".$pref['ab_admail']."'></input></td></tr>";
	$text .= "<tr><td class='forumheader3'>".AB_CONF_02."</td><td class='forumheader3'><input type='text' name='ab_days' class='tbox' value='".$pref['ab_days']."' size='40'></td></tr>";
	$text .= "<tr><td class='forumheader3'>".AB_CONF_10."</td><td class='forumheader3'><input type='text' name='ab_prolong' class='tbox' value='".$pref['ab_prolong']."' size='40'></td></tr>";
	$text .= "<tr><td class='forumheader3'>".AB_CONF_03."</td>
	<td class='forumheader3'><select class='tbox' type='text' name='ab_dateformat'>
		<option value='".$pref['ab_dateformat']."'>".$pref['ab_dateformat']."
		<option value=".AB_FDATE_01.">".AB_RDATE_01."
		<option value=".AB_FDATE_01.">".AB_RDATE_02."
	</select></td></tr>";
	$text .= "<tr><td class='forumheader3'>".AB_CONF_04."</td><td class='forumheader3'><input type='text' name='ab_sizepicbig' class='tbox' value='".$pref['ab_sizepicbig']."' size='40'></td></tr>";
	$text .= "<tr><td class='forumheader3'>".AB_CONF_05."</td><td class='forumheader3'><input type='text' name='ab_sizepicsmall' class='tbox' value='".$pref['ab_sizepicsmall']."' size='40'></td></tr>";
	$text .= "<tr><td class='forumheader3'>".AB_CONF_06."</td><td class='forumheader3'><input type='text' name='ab_showcols' class='tbox' value='".$pref['ab_showcols']."' size='40'></td></tr>";
	$text .= "<tr><td class='forumheader3'>".AB_CONF_07."</td><td class='forumheader3'><input type='text' name='ab_showrows' class='tbox' value='".$pref['ab_showrows']."' size='40'></td></tr>";
	$text .= "<tr><td class='forumheader' colspan='2' style='text-align:center'><input class='button' name='savesettings' type='submit' value= ".AB_BUT_AGR."></td></tr></table></form>";
$caption = AB_CONF_00;
$ns -> tablerender($caption, $text);
require_once(e_ADMIN."footer.php");
exit;
...
$text="<table><tr>";
$text.="<td><a href='http://e107.compolys.ru'><img src='".e_PLUGIN."abook/theme/logo_compolys.png' alt='".AB_INFO."'></a>";
...
$text.="".AB_ABO_18."<br>";
$text.="".AB_ABO_19."<br>";
$text.="<font color=blue>".AB_ABO_INFO."</font><br>";
$text.="<b>".AB_ABO_20."</b><br>";
$text.="".AB_ABO_21."<br>";
$text.="".AB_ABO_22."<br>";
$text.="".AB_ABO_23."<br>";
$text.="".AB_ABO_24."<br>";
