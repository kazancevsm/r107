...
*
* $URL: https://e107.svn.sourceforge.net/svnroot/e107/trunk/e107_0.7/e107_plugins/calendar/calendar_menu.php $
...
$calendar_title = "<a class='forumlink' href='".e_PLUGIN."calendar/";
...
{   // Four cases to decode:
    ...
    {  // Dates match for this month
        ...
        {	// Events happening today
			...
			{
				$cal_event_icon = "calendar/images/" . $cal_events[$cal_c]['0'];
        ...
        $cal_text .= $CALENDAR_MENU_DAY_START[$cal_css]."<a {$title} href='" . e_PLUGIN_ABS."calendar/event.php?{$cal_linkut}'>{$cal_img}</a>";
