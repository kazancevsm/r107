...
|
|     $URL: https://e107.svn.sourceforge.net/svnroot/e107/trunk/e107_0.7/e107_plugins/calendar/calendar_shortcodes.php $
|     $Revision: 11915 $
...
SC_BEGIN SHOWEVENT_IMAGE
	...
	$img = '';
	if($ev['event_cat_icon'] && file_exists(e_PLUGIN."calendar/images/".$ev['event_cat_icon']))
	{
	  $img = "<img style='border:0' src='".e_PLUGIN_ABS."calendar/images/".$ev['event_cat_icon']."' alt='' height='".$ev['imagesize']."' width='".$ev['imagesize']."' />";
	}
	...
	return $img;
	//return "<img style='border:0' src='".e_PLUGIN_ABS."calendar/images/".$ev['event_cat_icon']."' alt='' height='".$ev['imagesize']."' width='".$ev['imagesize']."' />";
SC_END
...
SC_BEGIN SHOWEVENT_HEADING
	...
	if($ev['startofevent'])
	{
	    return "<b><a title='{$ev['event_title']}' href='".e_PLUGIN_ABS."calendar/event.php?".$linkut.".event.".$ev['event_id']."'><span class='mediumtext'>".$show_title."</span></a></b>";
	}
	else
	{
	  return "<a title='{$ev['event_title']}' href='".e_PLUGIN_ABS."calendar/event.php?".$linkut.".event.".$ev['event_id']."'><span class='smalltext'>".$show_title."</span></a>";
	}
SC_END
...
SC_BEGIN CALENDAR_CALENDAR_DAY_TODAY_HEADING
	...
	return "<b><a href='".e_PLUGIN_ABS."calendar/event.php?".$startt."'>".$days[($c-1)]."</a></b> <span class='smalltext'>[".EC_LAN_TODAY."]</span>";
SC_END

SC_BEGIN CALENDAR_CALENDAR_DAY_EVENT_HEADING
	global $CALENDAR_CALENDAR_DAY_EVENT_HEADING, $startt, $c, $days;
	return "<a href='".e_PLUGIN_ABS."calendar/event.php?".$startt.".one'>".$days[($c-1)]."</a>";
SC_END

SC_BEGIN CALENDAR_CALENDAR_DAY_EMPTY_HEADING
	global $CALENDAR_CALENDAR_DAY_EMPTY_HEADING, $startt, $c, $days;
	return "<a href='".e_PLUGIN_ABS."calendar/event.php?".$startt."'>".$days[($c-1)]."</a>";
SC_END
...
SC_BEGIN EVENT_CAT_ICON
  global $thisevent;
  if ($thisevent['event_cat_icon'] && file_exists(e_PLUGIN."calendar/images/".$thisevent['event_cat_icon']))
	{
	  return "<img style='border:0' src='".e_PLUGIN_ABS."calendar/images/".$thisevent['event_cat_icon']."' alt='' /> ";
	}
	else
	{
		return "";
...
SC_BEGIN EVENT_OPTIONS
	...
	if (USERNAME == $event_author_name || $cal_super){
		$EVENT_OPTIONS = "<a href='event.php?ed.".$thisevent['event_id']."'><img style='border:0;' src='".e_IMAGE_ABS."admin/edit_16.png' title='".EC_LAN_35."' alt='".EC_LAN_35 . "'/></a>&nbsp;&nbsp;<a href='".e_PLUGIN."calendar/event.php?de.".$thisevent['event_id']."'><img style='border:0;' src='".e_IMAGE_ABS."admin/delete_16.png' title='".EC_LAN_36."' alt='".EC_LAN_36."'/></a>";
	}
...
SC_BEGIN NEXT_EVENT_TITLE
  ...
  if (isset($pref['eventpost_namelink']) && ($pref['eventpost_namelink'] == '2') && (isset($cal_row['event_thread']) && ($cal_row['event_thread'] != "")))
	  ...
	  { 
	    $fe_event_title = "<a href='".e_PLUGIN."calendar/event.php?".$cal_row['event_start'].".event.".$cal_row['event_id']."'>";
	  }
