...
|
|     $URL: https://e107.svn.sourceforge.net/svnroot/e107/trunk/e107_0.7/e107_plugins/calendar/calendar_template.php $
|     $Revision: 11678 $
...
$CALENDAR_TIME_TABLE = "
<table cellpadding='0' cellspacing='1' class='r_border' style='width:100%'>
<tr>
	<td class='r_header1' style='width:18%; text-align:left'>{PREV_MONTH}</td>
	<td class='r_caption' style='width:64%; text-align:center'>{CURRENT_MONTH}</td>
	<td class='r_header1' style='width:18%; text-align:right'>{NEXT_MONTH}</td>
</tr>\n
<tr>
	<td class='r_header3' style='text-align:left'>{PREV_YEAR}</td>
	<td class='r_caption' style='text-align:center; vertical-align:middle'>{MONTH_LIST}</td>
	<td class='r_header3' style='text-align:right'>{NEXT_YEAR}</td>
</tr>\n
</table>";
...
// EVENT LIST ------------------------------------------------------------
$sc_style['EVENTLIST_CAPTION']['pre'] = "<tr><td class='r_caption' colspan='2'>";
$sc_style['EVENTLIST_CAPTION']['post'] = ":<br /><br /></td></tr>\n";

$EVENT_EVENTLIST_TABLE_START = "<table style='width:100%' class='r_border'>{EVENTLIST_CAPTION}";
$EVENT_EVENTLIST_TABLE_END = "</table>";



// EVENT ARCHIVE ------------------------------------------------------------
$sc_style['EVENTARCHIVE_CAPTION']['pre'] = "<tr><td colspan='2' class='r_caption'>";
$sc_style['EVENTARCHIVE_CAPTION']['post'] = "</td></tr>\n";

$EVENT_ARCHIVE_TABLE_START = "<br /><table style='width:100%' class='r_border'>{EVENTARCHIVE_CAPTION}";
$EVENT_ARCHIVE_TABLE = "
<tr>
	<td style='width:35%; vertical-align:top' class='r_header3'>{EVENT_RECENT_ICON}{EVENTARCHIVE_DATE}</td>
	<td style='width:65%' class='r_header3'>{EVENTARCHIVE_HEADING}</td>
</tr>\n";
//<br />{EVENTARCHIVE_DETAILS}
$EVENT_ARCHIVE_TABLE_EMPTY = "<tr><td colspan='2' class='r_header3'>{EVENTARCHIVE_EMPTY}</td></tr>\n";
$EVENT_ARCHIVE_TABLE_END = "</table>";



// EVENT SHOW EVENT ------------------------------------------------------------
$EVENT_EVENT_TABLE_START = "<table style='width:100%' class='r_border' cellspacing='0' cellpadding='0'>";
$EVENT_EVENT_TABLE_END = "</table>";

$sc_style['EVENT_HEADING_DATE']['pre'] = "";
$sc_style['EVENT_HEADING_DATE']['post'] = "";

$sc_style['EVENT_DETAILS']['pre'] = "<tr><td colspan='2' class='r_header3'>";
...
$sc_style['EVENT_THREAD']['pre'] = "<tr><td colspan='2' class='r_header3'><span class='smalltext'>";
...
<tr>
	<td >
		<div title='".EC_LAN_132."' class='r_caption' style='cursor:pointer; text-align:left; border:0px solid #000;' onclick=\"expandit('{EVENT_ID}')\">{EVENT_RECENT_ICON}{EVENT_CAT_ICON}{EVENT_HEADING_DATE}{EVENT_TIME_START}&nbsp;-&nbsp;{EVENT_TITLE}</div>
		<div id='{EVENT_ID}' style='display:{EVENT_DISPLAYSTYLE}; padding-top:10px; padding-bottom:10px; text-align:left;'>
			<table style='width:100%;'  cellspacing='0' cellpadding='0'>
				<tr><td colspan='2' class='r_header3'>{EVENT_AUTHOR} {EVENT_CAT_ICON} {EVENT_CATEGORY} {EVENT_CONTACT} {EVENT_OPTIONS}</td></tr>
				<tr><td colspan='2' class='r_header3'>{EVENT_DATE_START}{EVENT_TIME_START} {EVENT_DATE_END}{EVENT_TIME_END}</td></tr>\n
				<tr><td colspan='2' class='r_header3'>{EVENT_LOCATION}</td></tr>
				{EVENT_DETAILS}
				{EVENT_THREAD}
			</table>
		</div>
...
<table cellpadding='0' cellspacing='1' class='r_border' style='background-color:#DDDDDD; width:100%'>";
...
$CALENDAR_CALENDAR_HEADER = "<td class='r_caption' style='z-index: -1; background-color:#000; color:#FFF; width:90px; height:20px; text-align:center; vertical-align:middle;'>{CALENDAR_CALENDAR_HEADER_DAY}</td>";
...
<td class='r_header3' style='vertical-align:top; width:14%; height:90px; padding-bottom:0px;padding-right:0px; margin-right:0px; padding:2px;'>
...
<td class='r_header3' style='z-index: 1;vertical-align:top; width:14%; height:90px; padding-bottom:0px;padding-right:0px; margin-right:0px; padding:2px;'>
...
<td class='r_header2' style='z-index: 1;vertical-align:top; width:14%; height:90px;padding-bottom:0px;padding-right:0px; margin-right:0px; padding:2px;'>
...
$CALENDAR_MENU_TABLE_START =   "<table cellpadding='0' cellspacing='1' style='width:100%' class='r_border'>";

$CALENDAR_MENU_END = "</tr></table></div>";

// Blank cells at beginning and end
$CALENDAR_MENU_DAY_NON = "<td class='r_header3' style='padding:1px; text-align:center'><br /></td>";

//header row
$CALENDAR_MENU_HEADER_START = "<tr>\n";
$CALENDAR_MENU_HEADER_FRONT = "<td class='r_header1' style='text-align:center; vertical-align:middle;'><span class='smalltext'>";
...
// no events and not today
$CALENDAR_MENU_DAY_START['2'] = "<td class='r_header3' style='width:14.28%; padding:1px; text-align:center; '>";
