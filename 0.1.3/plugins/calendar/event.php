...
|
|     $URL: https://e107.svn.sourceforge.net/svnroot/e107/trunk/e107_0.7/e107_plugins/calendar/event.php $
|     $Revision: 11678 $
...
{  // Triggered from NAV_BUT_ALLEVENTS
    header("Location: ".e_PLUGIN."calendar/calendar.php?".$_POST['enter_new_val']);
	exit;
}

if (isset($_POST['doit']))
{  // Triggered from NAV_BUT_ENTEREVENT
    header("Location: ".e_PLUGIN."calendar/event.php?ne.".$_POST['enter_new_val']);
	exit;
}

if (isset($_POST['subs']))
{
    header("Location: ".e_PLUGIN."calendar/subscribe.php");
	exit;
}
...
//			alert('Format: ' + arrstr + '    Start date: '+ sdate + '    End date: ' + edate);
    ...
    {
        header("location:".e_PLUGIN."calendar/event.php");
        exit;
    }
...
{
  require(e_PLUGIN."calendar/calendar_template.php");
}
