...
|
|     $URL: https://e107.svn.sourceforge.net/svnroot/e107/trunk/e107_0.7/e107_plugins/calendar/next_event_menu.php $
|     $Revision: 11678 $
...
{
  $calendar_title = "<a class='forumlink' href='" . e_PLUGIN . "calendar/event.php' >" . $menu_title . "</a>";
}
