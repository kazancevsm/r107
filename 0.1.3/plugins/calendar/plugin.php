...
|
|     $URL: https://e107.svn.sourceforge.net/svnroot/e107/trunk/e107_0.7/e107_plugins/calendar/plugin.php $
...
$eplug_folder = "calendar";

// Name of menu item for plugin ----------------------------------------------------------------------------------
$eplug_menu_name = "calendar";
...
$ecalSQL = new db;
$ecalSQL->db_Select("plugin", "plugin_version", "plugin_path='calendar' AND plugin_installflag > 0");
...
$eplug_done = EC_LAN_82; // "To activate please go to your menus screen and select the calendar into one of your menu areas.";
