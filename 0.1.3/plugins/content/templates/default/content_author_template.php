...
$sc_style['CONTENT_AUTHOR_TABLE_LASTITEM']['pre'] = "<tr><td class='r_header3'>".CONTENT_LAN_55." ";
...
if(!isset($CONTENT_AUTHOR_TABLE)){
	...
	<tr>
		<td class='r_caption'>{CONTENT_AUTHOR_TABLE_ICON} {CONTENT_AUTHOR_TABLE_NAME} {CONTENT_AUTHOR_TABLE_TOTAL}</td>
	</tr>
