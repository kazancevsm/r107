...
$sc_style['CONTENT_CAT_TABLE_ICON']['pre'] = "<td class='r_header3' rowspan='5' style='width:5%; white-space:nowrap; padding-right:5px;'>";
...
$sc_style['CONTENT_CAT_TABLE_SUBHEADING']['pre'] = "<tr><td class='r_header3'>";
$sc_style['CONTENT_CAT_TABLE_SUBHEADING']['post'] = "<br /></td></tr>";

$sc_style['CONTENT_CAT_TABLE_TEXT']['pre'] = "<tr><td class='r_header3'>";
$sc_style['CONTENT_CAT_TABLE_TEXT']['post'] = "<br /></td></tr>";

$sc_style['CONTENT_CAT_TABLE_RATING']['pre'] = "<tr><td class='r_header3'>";
...
$sc_style['CONTENT_CAT_TABLE_INFO_PRE']['pre'] = "<tr><td class='r_header3'>";
...
if(!isset($CONTENT_CAT_TABLE)){
	...
	<tr>
		...
		<td class='r_caption' >{CONTENT_CAT_TABLE_HEADING} {CONTENT_CAT_TABLE_AMOUNT}</td>
	</tr>
...
$sc_style['CONTENT_CAT_LIST_TABLE_ICON']['pre'] = "<td class='r_header3' style='width:5%; white-space:nowrap; padding-right:5px;' rowspan='5'>";
$sc_style['CONTENT_CAT_LIST_TABLE_ICON']['post'] = "</td>";

$sc_style['CONTENT_CAT_LIST_TABLE_SUBHEADING']['pre'] = "<tr><td class='r_header3'>";
...
$sc_style['CONTENT_CAT_LIST_TABLE_RATING']['pre'] = "<tr><td class='r_header3'>";
$sc_style['CONTENT_CAT_LIST_TABLE_RATING']['post'] = "</td></tr>";

$sc_style['CONTENT_CAT_LIST_TABLE_TEXT']['pre'] = "<tr><td class='r_header3'>";
...
$sc_style['CONTENT_CAT_LIST_TABLE_INFO_PRE']['pre'] = "<tr><td class='r_header3'>";
...
if(!isset($CONTENT_CAT_LIST_TABLE)){
	...
	<table class='r_border' style='width:98%; text-align:left; margin-bottom:10px;'>
	<tr>
		{CONTENT_CAT_LIST_TABLE_ICON}
		<td class='r_caption'>{CONTENT_CAT_LIST_TABLE_HEADING} {CONTENT_CAT_LIST_TABLE_AMOUNT}</td>
	</tr>
...
$sc_style['CONTENT_CAT_LISTSUB_TABLE_ICON']['pre'] = "<td class='r_header3' style='width:2%; white-space:nowrap; padding-right:5px; ' rowspan='2'>";
$sc_style['CONTENT_CAT_LISTSUB_TABLE_ICON']['post'] = "</td>";

$sc_style['CONTENT_CAT_LISTSUB_TABLE_SUBHEADING']['pre'] = "<tr><td class='r_header3'>";
...
if(!isset($CONTENT_CAT_LISTSUB_TABLE)){
	...
	<tr>
		...
		<td class='r_caption'>{CONTENT_CAT_LISTSUB_TABLE_HEADING} {CONTENT_CAT_LISTSUB_TABLE_AMOUNT}</td>
	</tr>
