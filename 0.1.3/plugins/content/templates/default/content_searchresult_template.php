...
$sc_style['CONTENT_SEARCHRESULT_TABLE_ICON']['pre'] = "<td class='r_header3'>";
$sc_style['CONTENT_SEARCHRESULT_TABLE_ICON']['post'] = "</td>";

$sc_style['CONTENT_SEARCHRESULT_TABLE_HEADING']['pre'] = "<tr><td class='r_caption'>";
$sc_style['CONTENT_SEARCHRESULT_TABLE_HEADING']['post'] = "</td></tr>";

$sc_style['CONTENT_SEARCHRESULT_TABLE_SUBHEADING']['pre'] = "<tr><td class='r_header3'>";
...
$sc_style['CONTENT_SEARCHRESULT_TABLE_TEXT']['pre'] = "<tr><td class='r_header3'>";
		...
		<tr>
			...
			<td>
				<table style='width:100%;' cellpadding='0' cellspacing='0'>
					...
					<tr><td class='r_header3'>{CONTENT_SEARCHRESULT_TABLE_AUTHORDETAILS} {CONTENT_SEARCHRESULT_TABLE_DATE}</td></tr>
