...
$sc_style['CONTENT_TOP_TABLE_ICON']['pre'] = "<td class='r_header3' rowspan='3' style='width:5%; white-space:nowrap;'>";
$sc_style['CONTENT_TOP_TABLE_ICON']['post'] = "</td>";

$sc_style['CONTENT_TOP_TABLE_HEADING']['pre'] = "";
$sc_style['CONTENT_TOP_TABLE_HEADING']['post'] = "";

$sc_style['CONTENT_TOP_TABLE_AUTHOR']['pre'] = "<tr><td class='r_header3' colspan='2'>".CONTENT_LAN_11." ";
$sc_style['CONTENT_TOP_TABLE_AUTHOR']['post'] = "</td></tr>";

$sc_style['CONTENT_TOP_TABLE_RATING']['pre'] = "<td class='r_caption' style='width:20%; white-space:nowrap; text-align:right;'>";
...
if(!isset($CONTENT_TOP_TABLE)){
	...
	<tr>
		...
		<td class='r_caption'>{CONTENT_TOP_TABLE_HEADING}</td>
