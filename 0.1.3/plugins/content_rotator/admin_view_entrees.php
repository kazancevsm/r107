...
*/
   ...
   require_once(e_ADMIN."auth.php");
	...
	$text .= 	"</td>
				...
				<td class='forumheader3'>
					<a href='admin_config.php?edit.".$id[$i].".$type'><img src='".e_IMAGE."admin_images/edit_16.png' alt='Edit' title='Edit' /></a>
					<a href='admin_config.php?delete.".$id[$i]."'><img src='".e_IMAGE."admin_images/delete_16.png' alt='Delete' title='Delete' /></a>
					<br/>
					".LAN_C_ROTATOR_MENU_10.":<br/>";
	if($order[$i] != count($id))
	$text .= "				<a href='handlers/order.php?moveup.".$id[$i].".".$order[$i]."'><img src='".e_IMAGE."admin_images/up.png' alt='Edit' title='Edit' /></a>";
    if($order[$i] != 1)
	$text .= "				<a href='handlers/order.php?movedown.".$id[$i].".".$order[$i]."'><img src='".e_IMAGE."admin_images/down.png' alt='Delete' title='Delete' /></a>";
