...
*/
	...
	if($action == 'main'){
        ...
        <td colspan="3" style="text-align:center;" class="r_header1">'. LOGINZA_ADMIN_CONF .'</td></tr>
		<tr><td style="width:40%" class="r_header3" colspan="2">' . LOGINZA_ADMIN_PROVS . '<br />'.LOGINZA_ADMIN_PROV.'</td>
		...
		<tr><td style="width:40%" class="r_header3" colspan="2">' . LOGINZA_ADMIN_LANG . '</td>
	    <td style="width:50%" class="r_header3"><select class = "tbox" name = "loginza_lang" />
		...
		<tr><td style="width:40%" class="r_header3" colspan="2">' . LOGINZA_ADMIN_CONNECT . '</td>
	    <td style="width:50%" class="r_header3"><select class = "tbox" name = "loginza_connect" />'
		...
		<tr><td style="width:40%" class="r_header3" colspan="2">' . LOGINZA_MENU_TITLE . '</td>
	    <td style="width:50%" class="r_header3">
		<input type="text" name="loginza_menu_title" class="tbox" style="width:97%" value="'.$pref['loginza_menu_title'].'" />
		</td></tr>
		<tr>
			<td style="width:40%" class="r_header3" rowspan="3">' . LOGINZA_SECURE_LOGIN . LOGINZA_SECURE_DESC . '</td>
			<td class="r_header3"><label for="loginza_secure_login">'.LOGINZA_ENABLED.'</label></td>
			<td class="r_header3"><input type="checkbox" name="loginza_secure_login" id="loginza_secure_login" class="tbox" value="1" '
			.($pref['loginza_secure_login']=='1'?'checked="checked"':'').' /></td>
		</tr>
		<tr>
			<td style="width:10%" class="r_header3">ID:</td>
			<td class="r_header3"><input type="text" name="loginza_widget_id" class="tbox" style="width:97%" value="'
			.$pref['loginza_widget_id'].'" /></p></td>
		</tr>
		<tr>
			<td class="r_header3">'.LOGINZA_SECRET_KEY.'</td>
			<td class="r_header3"><input type="text" name="loginza_api_signature" class="tbox" style="width:97%" value="'
		...
		<table style="'.$width.'" class="r_border" cellspacing="0" cellpadding="0">
		<tr style="vertical-align:top">
        <td colspan="2" style="text-align:center;" class="r_header1">'. LOGINZA_ADMIN_STAT .'</td></tr>';
		for($i=0;$i<count($td);$i++){
			
			$text .= '<tr><td style="width:30%" class="r_header3">' . $loginza->getprovico($td[$i]['provider']) . '</td>
			<td style="width:30%" class="r_header3">
			'.intval($td[$i]['id']).'
			</td></tr>';
		}
        $text .= '
		<tr><td style="width:30%" class="r_header3">' . LOGINZA_ADMIN_TOTAL . '</td>
    	<td style="width:30%" class="r_header3">
		'.intval($total).'
		</td></tr>
		<tr style="vertical-align:top">
