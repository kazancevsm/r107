...
if (isset($tmp[1]) && $tmp[1] == "num_page"){
	...
	$text .= "<tr>";
	$text .= "<td width='5%' class='fcaption'>".NB_GNL_ID."</td>";
	$text .= "<td width='5%' class='fcaption'>".NB_GNL_IMG."</td>";
	$text .= "<td width='55%' class='fcaption'>".NB_GNL_NAME."</td>";
	$text .= "<td width='10%' class='fcaption'>".NB_GNL_USER."</td>";
	$text .= "<td width='20%' class='fcaption'>".NB_GNL_DATE."</td>";
	$text .= "<td width='5%' class='fcaption'>".NB_GNL_OPT."</td>";
	$text .= "</tr>";
	...
	$text .= " <a href='".e_PLUGIN."md_nboard/admin_config.php?gnl.delete.$gnl_id' style='cursor:pointer;' onclick=\"return jsconfirm('".NB_QUE_DEL_NOT." [ ID: $gnl_id] ]')\">".ADMIN_DELETE_ICON."</a>";
	$text .= "</td>";
	$text .= "</tr>";
	}
...
if($iconlist = $fl->get_files(e_PLUGIN."md_nboard/theme/icons_cat/", ".jpg|.gif|.png|.JPG|.GIF|.PNG")){
	...
	$text .= "<tr><td class='forumheader'></td><td class='forumheader'>
		...
		<input type='reset' class='button' style='cursor:pointer;display:$unvis' value=".NB_BUT_CANS.">
		<input type='submit' class='button' style='cursor:pointer;display:$vis' value=".NB_BUT_UPD." name='submit_update'>
		<input type='reset' class='button' style='cursor:pointer;display:$vis' value=".NB_BUT_CANS.">
		</td></tr></table></form>";
$caption = NB_CAT_00;
$ns -> tablerender($caption, $text);
...
//-----editing form------------------------------------
	...
	$text .= "<tr><td class='forumheader2' width=100px>".NB_NOT_ID." *</td><td class='forumheader2' width=auto>
	<input type='text' class='tbox' name='gnl_id' value='$id'></td></tr>";
	
	$text .= "<tr><td class='forumheader2'>".NB_NOT_NAME." *</td><td class='forumheader2'>
	<input type='text' class='tbox' size='50' name='gnl_name' value='$gnl_name'></td></tr>";
	
	$text .= "<tr><td class='forumheader2'>".NB_CAT_02."</td><td class='forumheader2'>
		";
	$nbsql1 = new db;
	...
	$text .="<tr><td class='forumheader2'>".NB_NOT_CAT." *</td><td class='forumheader2'>
...
$text .="<tr><td class='forumheader2'>".NB_NOT_SCAT." *</td><td class='forumheader2'>
	...
	$text .= "<tr><td class='forumheader2'>".NB_NOT_DET." *</td><td class='forumheader2'>
	<textarea class='tbox' name='gnl_detail' cols=30 rows=10>$gnl_detail</textarea></td>";
	
	$text .= "<tr><td class='forumheader2'>".NB_NOT_PRICE." *</td><td class='forumheader2'>
	<input class='tbox' type='text' size='50' name='gnl_price' value='$gnl_price'></td>";
	
	$text .= "<tr><td class='forumheader2' width='30%'>".NB_NOT_USER." *</td><td class='forumheader2' width='70%'>
	<input type='text' class='tbox' size='50' name='gnl_user' value='$gnl_user'></td>";
	
	$text .= "<tr><td class='forumheader2'>".NB_NOT_CITY." *</td><td class='forumheader2'>
	<input type='text' class='tbox' size='50' name='gnl_city' value='$gnl_city'></td>";
	
	$text .= "<tr><td class='forumheader2'>".NB_NOT_PHONE." *</td><td class='forumheader2'>
	<input class='tbox' type='text' size='50' name='gnl_phone' value='$gnl_phone'></td>";
	
	$text .= "<tr><td class='forumheader2'>".NB_NOT_EMAIL."</td><td class='forumheader2' width='70%'>
	<input class='tbox' type='text' size='50' name='gnl_email' value='$gnl_email'></td>";
	
	$text .= "<tr><td class='forumheader2'>".NB_NOT_LONG."*</td> <td class='forumheader2'><select class='tbox' name='days'>";
	$text .= "<option value=''></option>";
	$text .= "<option value='15'>".NB_NOT_DATESTART."</option>";
	$text .= "<option value='30'>".NB_NOT_DATESTOP."</option>";
	$text .= "</select>";
...
$text .= "<br><br><a href='".e_PLUGIN."md_nboard/admin_config.php?delete.delete_old' style='cursor:pointer;' onclick=\"return jsconfirm('".NB_QUE_DEL_NOTOLD."')\">[Удалить все старые объявления]</a><br><br>";
...
$text ="<form name='banner_add' method='post' action='' enctype='multipart/form-data'><table class='fborder' style='width:100%'>";
	...
	$text .= "<tr><td class='forumheader3'>".NB_BAN_05."</td><td class='forumheader3' width='80%'><input size='16' type='text' name='ban_datebegin' class='tbox' value='$ban_datebegin' onclick='event.cancelBubble=true;this.select();lcs(this)' <script src='".e_PLUGIN."md_nboard/js/calendar_ru.js'></script><style>
...
if(IsSet($_POST['savesettings'])){
	...
	$text .="<form enctype='multipart/form-data' name='form_config' method='post' action=''><table class='fborder' style='width:100%' align='center'>";
        $text .= "<tr><td class='forumheader3' width='60%'>".NB_CONF_MAIL."</td><td class='forumheader3'><input class='tbox' size='40' type='text' name='nb_admail' value='".$pref['nb_admail']."'></input></td></tr>";
	$text .= "<tr><td class='forumheader3'>".NB_CONF_DAY."</td><td class='forumheader3'><input type='text' name='nb_days' class='tbox' value='".$pref['nb_days']."' size='40'></td></tr>";
	$text .= "<tr><td class='forumheader3'>".NB_CONF_PROLONG."</td><td class='forumheader3'><input type='text' name='nb_prolong' class='tbox' value='".$pref['nb_prolong']."' size='40'></td></tr>";
	$text .= "<tr><td class='forumheader3'>".NB_CONF_FORM."</td>
	...
	$text .= "<tr><td class='forumheader3'>".NB_CONF_IMBIG."</td><td class='forumheader3'><input type='text' name='nb_sizepicbig' class='tbox' value='".$pref['nb_sizepicbig']."' size='40'></td></tr>";
	$text .= "<tr><td class='forumheader3'>".NB_CONF_IMSMALL."</td><td class='forumheader3'><input type='text' name='nb_sizepicsmall' class='tbox' value='".$pref['nb_sizepicsmall']."' size='40'></td></tr>";
	$text .= "<tr><td class='forumheader3'>".NB_CONF_COL1."</td><td class='forumheader3'><input type='text' name='nb_showcols' class='tbox' value='".$pref['nb_showcols']."' size='40'></td></tr>";
	$text .= "<tr><td class='forumheader3'>".NB_CONF_ROW1."</td><td class='forumheader3'><input type='text' name='nb_showrows' class='tbox' value='".$pref['nb_showrows']."' size='40'></td></tr>";
	$text .= "<tr><td class='forumheader3'>".NB_CONF_ROW2."</td><td class='forumheader3'><input type='text' name='nb_menu_showrows' class='tbox' value='".$pref['nb_menu_showrows']."' size='40'></td></tr>";
	$text .= "<tr><td class='forumheader3'>".NB_CONF_QUE."</td><td class='forumheader3'><input type='text' name='nb_check_que' class='tbox' value='".$pref['nb_check_que']."' size='40'></td></tr>";
	$text .= "<tr><td class='forumheader3'>".NB_CONF_ANS."</td><td class='forumheader3'><input type='text' name='nb_check_ans' class='tbox' value='".$pref['nb_check_ans']."' size='40'></td></tr>";
	$text .= "<tr><td class='forumheader3'>".NB_CONF_COMMENT."</td>
...
$text="<h1>".NB_INFO." RC ".NB_VERSION."</h1><br><br>";

$text .= NB_ABO_INFO."<br><br>";
$text .= "<b><a href='".e_PLUGIN."md_nboard/doc/".e_LANGUAGE.".pdf'>".NB_ABO_DOC."</a></b><br>";
...
<br><a href='http://e107.compolys.ru'><img src='".e_PLUGIN."md_nboard/theme/logo_compolys.png' alt='".NB_INFO."'></a>";
$text .= "</tr></table>";
$caption = NB_ABO_CAP;
$ns -> tablerender($caption, $text);
require_once(e_ADMIN."footer.php");
...
{	
	...
	if (!isset($action) || ($action == "")){
		...
		show_admin_menu(NB_ADMIN_MENU_CAP, $action, $var);
}
?>