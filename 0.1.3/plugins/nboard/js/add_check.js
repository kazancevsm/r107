...
p_gnl_detail=document.form_add.gnl_detail.value;
	if (p_gnl_detail.length < 10 || p_gnl_detail.length > 1000) {
	document.getElementById('check_detail').innerHTML ='<img src="./theme/check_no.png"/> Введите не менее 10 знаков и не более 1000';
	return false;
	}else{
