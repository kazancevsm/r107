...
$contentA = array( // ORDER BY FirstName ASC ;)
	"<h3>".CRELAN_6."<\/h3>",
	"<h1>Казанцев Сергей<\/h1>[ Sunout ]<br /><br /><br />".CRELAN_777,
...
<body style='padding:0px; margin:0px; background-color: #f8f8f8; color: #8E8E8E'>

<div><center><img src='".e_IMAGE."logo.png' alt='' />
<div class='smalltext' style='background: #f8f8f8; width:90%; padding:2px; border: #000 solid 1px; border-radius: 4px; -moz-border-radius: 4px; -webkit-border-radius: 4px; -o-border-radius: 4px; color: #000; font-weight: bold;'>".CRELAN_7." ".$e107info['e107_version']."<br />&copy; 2002-2012 ".CRELAN_3." All Rights Reserved.<br />&copy; е107 Клуб, 2010-2012. Все права защищены.</div>
...
(e_QUERY && e_QUERY == "stps" ? "<input class='button' type='button' onclick=\"self.parent.location='".e_SYSTEM."credits.php'\" value='".CRELAN_4."' />" : "<input class='button' type='button' onclick=\"self.parent.location='".e_SYSTEM."credits.php?stps'\" value='".CRELAN_5."' />")."</div>
</form>
</div>
