...
return "<img src='".e_IMAGE_ABS."user/user_realname_".IMODE.".png' alt='' style='border:0px;vertical-align:middle;' /> ";
SC_END
...
return "<img src='".e_IMAGE_ABS."user/user_".IMODE.".png' alt='' style='border:0px;vertical-align:middle;' /> ";
SC_END
...
{
	$icon = "<img src='".e_IMAGE_ABS."user/user_".IMODE.".png' alt='' style='border:0px;vertical-align:middle;' /> ";
}
...
return "<img src='".e_IMAGE_ABS."user/user_birthday_".IMODE.".png' alt='' style='vertical-align:middle;' /> ";
SC_END
...
if($pref['profile_rate'] && USER)
{
	...
	if($rating = $rater->getrating('user', $user['user_id']))
	{
		...
		for($i=1; $i<= $num; $i++)
		{
			$ret .= "<img src='".e_IMAGE_ABS."user/user_star_".IMODE.".png' style='border:0' alt='' />";
		}
	}
