...
|     e107 website system
|
|     $URL: https://e107.svn.sourceforge.net/svnroot/e107/trunk/e107_0.7/e107_files/shortcode/sitelinks_alt.sc $
|     $Revision: 11678 $
|     $Id: sitelinks_alt.sc 11678 2010-08-22 00:43:45Z e107coders $
|     $Author: e107coders $
+----------------------------------------------------------------------------+
*/
		...
		$text = "<div id='l_".$id."' class='menu' onmouseover=\"menuMouseover(event)\">";
			foreach ($linklist['sub_'.$id] as $sub) {
                ...
                if (!$sub['link_button'] && $params[0] == 'no_icons') {
					...
					$sub_icon = "<img src='";
					$sub_icon .= ($sub['link_button']) ? e_FILE.'icons/'.$sub['link_button'] : $icon;
