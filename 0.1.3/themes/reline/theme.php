...
// Comment post style
$sc_style['REPLY']['pre'] = "<tr><td class='r_header1'>";
$sc_style['REPLY']['post'] = "</td>";

$sc_style['SUBJECT']['pre'] = "<td class='r_header1'>";
...
$COMMENTSTYLE = "<div class='spacer' style='text-align:center'><table class='r_border' style='width: 95%'>
<tr>
<td class='r_caption' colspan='2'>".LAN_THEME_5." {USERNAME} ".LAN_THEME_6." {TIMEDATE}
</td>
</tr>
{REPLY}{SUBJECT}
<tr>
<td style='width: 20%; vertical-align: top' class='r_header3'>
<div style='text-align: center'>
{AVATAR}
</div>
{LEVEL}<span class='smalltext'>{JOINED}{COMMENTS}{LOCATION}{IPADDRESS}</span>
</td>
<td style='width: 80%; vertical-align: top' class='r_header3'>
{COMMENT}
{RATING}
{SIGNATURE} 
</td>
