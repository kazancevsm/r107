...
$CALENDAR_CALENDAR_HEADER = "<td class='r_caption' style='z-index: -1; background-color:#F9F9F9; border-bottom: 1px #CCCCCC solid; width:90px; height:20px; text-align:center; vertical-align:middle;'>{CALENDAR_CALENDAR_HEADER_DAY}</td>";
