...
if(!isset($DOWNLOAD_CAT_TABLE_START))
{
                ...
                <tr>
                <td style='width:3%; text-align:center' class='r_caption'>&nbsp;</td>
                <td style='width:60%; text-align:center' class='r_caption'>".LAN_dl_19."</td>
                <td style='width:10%; text-align:center' class='r_caption'>".LAN_dl_20."</td>
                <td style='width:17%; text-align:center' class='r_caption'>".LAN_dl_21."</td>
                <td style='width:10%; text-align:center' class='r_caption'>".LAN_dl_77."</td>
                </tr>";
}
if(!isset($DOWNLOAD_CAT_PARENT_TABLE))
{
                ...
                <tr>
                <td colspan='5' class='r_header1' style='text-align:left; font-weight:bold;'>
...
if(!isset($DOWNLOAD_CAT_SUBSUB_TABLE))
{
	...
	<td class='r_header3'>
		...
		<td class='r_header3' style='width:100%'>
			<table>
			<tr>
				<td class='r_header3' style='border:0'>".
				LAN_dl_42."
				</td>
				<td class='r_header3' style='border:0'>
				{DOWNLOAD_CAT_SUBSUB_ICON}
				</td>
				<td class='r_header3' style='border:0; width: 100%'>
...
if(!isset($DOWNLOAD_CAT_TABLE_END))
{
                ...
                <tr><td class='r_header3' colspan='5' style='text-align:right;'>{DOWNLOAD_CAT_NEWDOWNLOAD_TEXT}</td></tr>
                <tr><td class='r_header3' colspan='5' style='text-align:right;'>{DOWNLOAD_CAT_SEARCH}</td></tr>
                </table>
                </div>\n";
}
// ##### ------------------------------------------------------------------------------------------
...
if(!isset($DOWNLOAD_LIST_TABLE_START))
{
                ...
                <table class='r_border' style='".USER_WIDTH."'>\n
                <tr>
        <td colspan='7' style='text-align:center' class='r_header1'>
        ...
        <tr>
        <td style='width:35%; text-align:center' class='r_caption'>".LAN_dl_28."</td>
        <td style='width:15%; text-align:center' class='r_caption'>".LAN_dl_22."</td>
        <td style='width:20%; text-align:center' class='r_caption'>".LAN_dl_24."</td>
        <td style='width:10%; text-align:center' class='r_caption'>".LAN_dl_21."</td>
        <td style='width:5%; text-align:center' class='r_caption'>".LAN_dl_29."</td>
        <td style='width:10%; text-align:center' class='r_caption'>".LAN_dl_12."</td>
        <td style='width:5%; text-align:center' class='r_caption'>".LAN_dl_8."</td>
        </tr>";
...
if(!isset($DOWNLOAD_LIST_TABLE_END))
{
		...
		<tr><td class='r_header3' colspan='7' style='text-align:right;'>{DOWNLOAD_LIST_TOTAL_AMOUNT} {DOWNLOAD_LIST_TOTAL_FILES}</td></tr>
		</table>
		</form>
		</div>\n";
}
...
$sc_style['DOWNLOAD_VIEW_AUTHOR_LAN']['pre'] = "<tr><td style='width:20%' class='r_header3'>";
$sc_style['DOWNLOAD_VIEW_AUTHOR_LAN']['post'] = "</td>";

$sc_style['DOWNLOAD_VIEW_AUTHOR']['pre'] = "<td style='width:80%' class='r_header3'>";
$sc_style['DOWNLOAD_VIEW_AUTHOR']['post'] = "</td></tr>";

$sc_style['DOWNLOAD_VIEW_AUTHOREMAIL_LAN']['pre'] = "<tr><td style='width:20%' class='r_header3'>";
$sc_style['DOWNLOAD_VIEW_AUTHOREMAIL_LAN']['post'] = "</td>";

$sc_style['DOWNLOAD_VIEW_AUTHOREMAIL']['pre'] = "<td style='width:80%' class='r_header3'>";
$sc_style['DOWNLOAD_VIEW_AUTHOREMAIL']['post'] = "</td></tr>";

$sc_style['DOWNLOAD_VIEW_AUTHORWEBSITE_LAN']['pre'] = "<tr><td style='width:20%' class='r_header3'>";
$sc_style['DOWNLOAD_VIEW_AUTHORWEBSITE_LAN']['post'] = "</td>";

$sc_style['DOWNLOAD_VIEW_AUTHORWEBSITE']['pre'] = "<td style='width:80%' class='r_header3'>";
$sc_style['DOWNLOAD_VIEW_AUTHORWEBSITE']['post'] = "</td></tr>";

$sc_style['DOWNLOAD_REPORT_LINK']['pre'] = "<tr><td style='width:20%' class='r_header3' colspan='2'>";
...
if(!isset($DOWNLOAD_VIEW_TABLE))
{
		...
		<table class='r_border' style='".USER_WIDTH."'>\n
		<tr>
		<td colspan='2' class='r_caption' style='text-align:left;'>
		{DOWNLOAD_VIEW_NAME}
		</td>
		</tr>
		...
		<tr>
		<td style='width:20%' class='r_header3'>{DOWNLOAD_VIEW_DESCRIPTION_LAN}</td>
		<td style='width:80%' class='r_header3'>{DOWNLOAD_VIEW_DESCRIPTION}</td>
		</tr>

		<tr>
		<td style='width:20%' class='r_header3'>{DOWNLOAD_VIEW_IMAGE_LAN}</td>
		<td style='width:80%' class='r_header3'>{DOWNLOAD_VIEW_IMAGE}</td>
		</tr>

		<tr>
		<td style='width:20%' class='r_header3'>{DOWNLOAD_VIEW_FILESIZE_LAN}</td>
		<td style='width:80%' class='r_header3'>{DOWNLOAD_VIEW_FILESIZE}</td>
		</tr>

		<tr>
		<td style='width:20%' class='r_header3'>{DOWNLOAD_VIEW_DATE_LAN}</td>
		<td style='width:80%' class='r_header3'>{DOWNLOAD_VIEW_DATE=long}</td>
		</tr>

		<tr>
		<td style='width:20%' class='r_header3'>{DOWNLOAD_VIEW_REQUESTED_LAN}</td>
		<td style='width:80%' class='r_header3'>{DOWNLOAD_VIEW_REQUESTED}</td>
		</tr>

		<tr>
		<td style='width:20%' class='r_header3'>{DOWNLOAD_VIEW_LINK_LAN}</td>
		<td style='width:80%' class='r_header3'>{DOWNLOAD_VIEW_LINK}</td>
		</tr>

		<tr>
		<td style='width:20%' class='r_header3'>{DOWNLOAD_VIEW_RATING_LAN}</td>
		<td style='width:80%' class='r_header3'>{DOWNLOAD_VIEW_RATING}</td>
		</tr>
...
if(!isset($DOWNLOAD_MIRROR_START))
{
	...
	<table class='r_border' style='".USER_WIDTH."'>
	<tr>
	<td class='r_caption' colspan='4'>{DOWNLOAD_MIRROR_REQUEST}</td>
	</tr>
	<tr>
	<td class='r_header1' style='width: 30%; text-align: center;'>{DOWNLOAD_MIRROR_HOST_LAN}</td>
	<td class='r_header1' style='width: 40%;'>{DOWNLOAD_MIRROR_DESCRIPTION_LAN}</td>
	<td class='r_header1' style='width: 20%; text-align: center;'>{DOWNLOAD_MIRROR_LOCATION_LAN}</td>
	<td class='r_header1' style='width: 10%; text-align: center;'>{DOWNLOAD_MIRROR_GET_LAN}</td>
	</tr>
	";
}
...
if(!isset($DOWNLOAD_MIRROR))
{
	$DOWNLOAD_MIRROR = "
	<tr>
	<td class='r_header3' style='width: 30%; text-align: center;'>{DOWNLOAD_MIRROR_IMAGE}<br /><br /><div class='smalltext'>{DOWNLOAD_MIRROR_REQUESTS}<br />{DOWNLOAD_TOTAL_MIRROR_REQUESTS}</div></td>
	<td class='r_header3' style='width: 40%'><div class='smalltext'>{DOWNLOAD_MIRROR_DESCRIPTION}</div></td>
	<td class='r_header3' style='width: 20%;; text-align: center;'>{DOWNLOAD_MIRROR_LOCATION}</td>
	<td class='r_header3' style='width: 10%; text-align: center;'><div class='smalltext'>{DOWNLOAD_MIRROR_LINK} {DOWNLOAD_MIRROR_FILESIZE}</div></td>
	</tr>
	";
}
