...
if(!isset($LOGIN_TABLE_HEADER))
{
	...
	<div style='width:100%;text-align:center; margin-left: auto;margin-right: auto;  margin-top: 0px'><br />
		<div style='text-align:center;width:70%;margin-left: auto;margin-right: auto'><a href='".SITEURL."'>
			".(file_exists(THEME."images/login_logo.png") ? "<img src='".THEME_ABS."images/e_logo.png' alt='".SITENAME."' />" : "<img src='".e_IMAGE."logo.png' alt='".SITENAME."' /></a>" );
}
...
if(!isset($LOGIN_TABLE_FOOTER))
{
			...
			<div style='width:70%;margin-right:auto;margin-left:auto; font-weight: bold;'>
				<div style='text-align:center'><br />
					{LOGIN_TABLE_FOOTER_USERREG}&nbsp;&nbsp;&nbsp;<a href='".e_BASE."fpw.php'>".LAN_LOGIN_FORGOTPAS."</a>
				</div>
			</div>
		</div>
	</div>";
