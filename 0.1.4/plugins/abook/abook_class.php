...
$color = 1;
	$text ="<table valign=top align=left><tr><td class='fcaption' width='30%'><b>".LAN_AB_LIST_NAME."</td>"; 
	$text .="<td class='fcaption' width='15%'><b>".LAN_AB_LIST_MAG."</td>"; 
	$text .="<td class='fcaption' width='10%'><b>".LAN_AB_LIST_CITY."</b></td>"; 
	$text .="<td class='fcaption' width='10%'><b>".LAN_AB_LIST_ADDR."</td>"; 
	$text .="</tr>";  
	while($row = mysql_fetch_assoc($query)){
		...
		if ($row['gnl_check_admin']==LAN_AB_SEL_YES){
...
$text ="<table style='width:100%' valign=top><tr >";
	while($row = mysql_fetch_assoc($query)){ 
		...
		$text .= "<td class='forumheader2' valign=top>".LAN_AB_LIST_NAME.":"; 
		$text .= "<b>".$row['gnl_name']."</b>"; 
		$text .= "<br>".LAN_AB_LIST_MAG.": <b>".$row['gnl_mag']."</b>"; 
		$text .= "<br>".LAN_AB_LIST_ADDR.": <b>".$row['gnl_address'].", ".$row['gnl_city']."</b>"; 
		$text .= "<br>".LAN_AB_LIST_SITE.": <b>".$row['gnl_site']."</b>"; 
		$text .= "<br>".LAN_AB_LIST_MAIL.": <b>".$row['gnl_mail']."</b>"; 
		$text .= "<br>".LAN_AB_LIST_ICQ.": <b>".$row['gnl_icq']."</b>"; 
		$text .= "<br></td></tr>"; 
	    }
	}
$text .="</table>";
...
$this1->sql .= " WHERE gnl_id=".$_GET['id'];
	...
	$text .="<table style='width:100%' valign=top><tr>"; 
	$text .="<td class='fcaption' width='50%'>".LAN_AB_LIST_DEV."</td>"; 
	$text .="<td class='fcaption' width='50%'>".LAN_AB_LIST_DESC."</td>"; 
	$text .="</tr>"; 
