...
+-------------------------------------------------------------------------------+
*/
define("LAN_ALTNEWS_NAME", "Другие новости");
define("LAN_ALTNEWS_ABOUT", "Плагин позволяет поменять способ отображения новостей, а так же отобразить новости с помощью меню. Включается плагин из раздела [Контент-Меню]");
