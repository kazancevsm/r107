...
|
|     $URL: https://e107.svn.sourceforge.net/svnroot/e107/trunk/e107_0.7/e107_plugins/calendar/search/search_parser.php $
|     $Revision: 11678 $
...
function search_events($row) {
	global $con;
	$res['link'] = e_PLUGIN."calendar/event.php?".time().".event.".$row['event_id'];
