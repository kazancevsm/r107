...
if ($_GET['user']) $user_id = $_GET['user'];

// ================ Navigation =================
if (!$n_show and $action != "comments") {
...
$text_gall = "\n <!-- #### Text Gall #### --> \n <div class='my_gall_page'>";
    ...
    // ========== Gallery Title Image ==================
if ($gallery == $folder and $pref['mg_minepage_logo'] and $action != "comments") {

  if ($title_image != "") $text_gall .= "<div align='center'><img src='$title_image'></div>";

}
//============= Last uploads gallery ======================
if ($gallery == $folder and $user_id == "" and $pref['mg_minepage_upload'] and $action != "comments") {
    ...
    $img_user = array();
      ...
      for ($i=0; $i<$foto_columns; $i++) {
        ...
        $replace = array("".(($img_user_id != "" and $img_user_id != "0") ? "<a href='".e_HTTP."user.php?id.".$img_user_id."' title='".MYGAL_L084."'>".$img_user_name."</a>" : MYGAL_L085)."",

                    "".(($img_user_id != "" and $img_user_id != "0") ? "<a href='".e_SELF."?user=".$img_user_id."' title='".MYGAL_L083."'>".$img_user_name."</a>" : MYGAL_L085)."",

					"".($img_title[$i] != "" ? "".$tp->toHTML($img_title[$i])."" : MYGAL_L085 )."",

					"".($img_description[$i] !="" ? "".$tp->toHTML($img_description[$i], true)."" : MYGAL_L085)."",

					"".$img_file."",

					"<a href='".e_SELF."?gallery=".$gallery."/".$folder_a."/".$folder_b."'>".($folder_name[$folder_0."/".$folder_a."/".$folder_b] !="" ? $folder_name[$folder_0."/".$folder_a."/".$folder_b] : $folder_b)."</a>",

					"".$info[0]."x".$info[1]."",

					"<a href='dload.php?file=".$folder_0."/".$folder_a."/".$folder_b."/".$img_file."'>".MYGAL_L022."</a>",

					"<a id='thumb_".$img_file."' alt='".($img_title[$i] != "" ? "".$tp->toHTML($img_title[$i])."" : "".MYGAL_L027." ".$img_file."" )."'
			        title='".($img_description[$i] !="" ? MYGAL_L037.": ".$img_description[$i] : "")."'
					...
					? "<a href='".e_PLUGIN."my_gallery/comments.php?comm_id=".$img_id[$i]."' onclick=\"return hs.htmlExpand(this, { contentId: 'highslide-html', objectType: 'iframe', objectWidth: 700, objectHeight: 500} )\" class='highslide'>".MYGAL_L045."".$mydb->db_Count("comments", "(*)", "WHERE comment_item_id = '".$img_id[$i]."' AND comment_type = 'my_gallery'")."</a>
        ...
        $mg_hs_caption = str_replace($search, $replace, $MG_LAST_HIGHSLIDE_CAPTION);

		$replace[] = "<div class='highslide-caption' id='caption_".$img_file."'>".$mg_hs_caption."</div>";
        $text_gall .= "<td width='". 100/$foto_columns ."%'>";
        $text_gall .= str_replace($search, $replace, $MG_LAST_IMG);
...
if ($gallery == $folder and $user_id == "" and $pref['mg_minepage_comment'] and $action != "comments") {
    ...
    $img_user = array();
      ...
      for ($i=0; $i<$foto_columns; $i++) {
            ...
            if ($img_user_mail !="") $img_user_mail = explode("@", $img_user_mail);
            if ($img_user_name == "") $img_user_name = MYGAL_L070;
            list($comments_user_id, $comments_user_name) = explode(".", $comments_author[$i]);

        list($folder_0, $folder_a, $folder_b, $img_file) = explode("/", $img_name[$i]);
        $info = getimagesize("".$folder_0."/".$folder_a."/".$folder_b."/".$img_file."");

        //============ Comment slide ===================
        $replace = array("".(($img_user_id != "" and $img_user_id != "0") ? "<a href='".e_HTTP."user.php?id.".$img_user_id."' title='".MYGAL_L084." ".$img_user_name."'>".$img_user_name."</a>" : MYGAL_L085)."".(($img_user_id != "" and $img_user_id == "0") ? "<a href='javascript:window.location=\"mai\"+\"lto:\"+\"$img_user_mail[0]\"+\"@\"+\"$img_user_mail[1]\";self.close();'>".$img_user_name."</a>" : "")."",

                    "".(($img_user_id != "" and $img_user_id != "0") ? "<a href='".e_SELF."?user=".$img_user_id."' title='".MYGAL_L083." ".$img_user_name."'>".$img_user_name."</a>" : MYGAL_L085)."",

					"".($img_title[$i] != "" ? "".$tp->toHTML($img_title[$i])."" : MYGAL_L085 )."",

					"".($img_description[$i] !="" ? "".$tp->toHTML($img_description[$i])."" : MYGAL_L085)."",

					"".$img_file."",

					"<a href='".e_SELF."?gallery=".$gallery."/".$folder_a."/".$folder_b."'>".($folder_name[$gallery."/".$folder_a."/".$folder_b] !="" ? $folder_name[$gallery."/".$folder_a."/".$folder_b] : $folder_b)."</a>",

					"".$info[0]."x".$info[1]."",

					"<a href='dload.php?file=".$folder_0."/".$folder_a."/".$folder_b."/".$img_file."'>".MYGAL_L022."</a>",

					"<a id='thumb_".$img_file."' alt='".($img_title[$i] != "" ? "".MYGAL_L036.": ".$img_title[$i]."" : "".MYGAL_L027." ".$img_file."" )."'
            			".($img_description[$i] !="" ? "title='".MYGAL_L037.": ".$img_description[$i]."'" : "")."
				            ".(file_exists("".$folder_0."/".$folder_a."/".$folder_b."/tv_".$img_file."")
				            ? "href='image.php?file=".$folder_0."/".$folder_a."/".$folder_b."/tv_".$img_file."'"
				            : "href='foto.php?img=".$folder_0."/".$folder_a."/".$folder_b."/".$img_file."&h=".$foto_view_height."&w=".$foto_view_width."'")."
				            class='highslide' onclick=\"return hs.expand(this, { captionId: 'caption_".$img_file."' } )\">
					...
					"".($pref['mygallery_comments']
					? "<a href='".e_PLUGIN."my_gallery/comments.php?comm_id=".$img_id[$i]."' onclick=\"return hs.htmlExpand(this, { contentId: 'highslide-html', objectType: 'iframe', objectWidth: 700, objectHeight: 500} )\" class='highslide'>
					".MYGAL_L045."".$mydb->db_Count("comments", "(*)", "WHERE comment_item_id = '".$img_id[$i]."' AND comment_type = 'my_gallery'")."
					</a>
				    <div class='highslide-html-content' id='highslide-html' style='width: 700px'>
				    	<div class='highslide-move' style='border: 0; height: 18px; padding: 2px; cursor: default'>
				    	    <a href='#' onclick='return hs.close(this)' class='control'>".MYGAL_L057."</a>
					...
					"".$tp->toHTML($comments[$i], true)."");

        $mg_hs_caption = str_replace($search, $replace, $MG_COMMENTS_HIGHSLIDE_CAPTION);

		$replace[] = "<div class='highslide-caption' id='caption_".$img_file."'>".$mg_hs_caption."</div>";

        $text_gall .= str_replace($search, $replace, $MG_LAST_COMMENT);

      }
 $text_gall .= "</td></tr></table>";
 }
}

// ================= Random Image Gallery ================
if ($gallery == $folder and $user_id == "" and $pref['mg_minepage_random'] and $action != "comments") {
    ...
    for ($j=0; $j<$foto_columns; $j++) {
        ...
        if ($file != "") {
	        ...
	        $replace = array("".(($img_user_id != "" and $img_user_id != "0") ? "<a href='".e_HTTP."user.php?id.".$img_user_id."' title='".MYGAL_L084." ".$img_user_name."'>".$img_user_name."</a>" : MYGAL_L085)."".(($img_user_id != "" and $img_user_id == "0") ? "<a href='javascript:window.location=\"mai\"+\"lto:\"+\"$img_user_mail[0]\"+\"@\"+\"$img_user_mail[1]\";self.close();'>".$img_user_name."</a>" : "")."",
	                    ...
	                    "".(($img_user_id != "" and $img_user_id != "0") ? "<a href='".e_SELF."?user=".$img_user_id."' title='".MYGAL_L083." ".$img_user_name."'>".$img_user_name."</a>" : MYGAL_L085)."".(($img_user_id != "" and $img_user_id == "0") ? "<a href='javascript:window.location=\"mai\"+\"lto:\"+\"$img_user_mail[0]\"+\"@\"+\"$img_user_mail[1]\";self.close();'>".$img_user_name."</a>" : "")."",
				        ...
				        ".($img_description !="" ? "title='".MYGAL_L037.": ".$img_description."'" : "")."'
						...
						".MYGAL_L045."".$mydb->db_Count("comments", "(*)", "WHERE comment_item_id = '".$comm_id."' AND comment_type = 'my_gallery'")."
						</a>
					    <div class='highslide-html-content' id='highslide-html' style='width: 700px'>
					    	<div class='highslide-move' style='border: 0; height: 18px; padding: 2px; cursor: default'>
					    	    <a href='#' onclick='return hs.close(this)' class='control'>".MYGAL_L057."</a>
	        ...
	        $text_gall .= str_replace($search, $replace, $MG_RANDOM_IMG);

	        $text_gall .= "</td>";
        } else { $c++; if ($c < ($foto_columns + 20)) $j--; }
    }
    $text_gall .= "</tr>";
    $text_gall .= "</table>";
    $text_gall .= "
...
if ($gallery != $folder and $user_id == "" and $action != "comments") {
...
define("e_PAGETITLE", "".PAGE_NAME." - ".($folder_name[$folder_0."/".$folder_a] != "" ? $folder_name[$folder_0."/".$folder_a] : $folder_a)." - ".($folder_name[$folder_0."/".$folder_a."/".$folder_b] != "" ? $folder_name[$folder_0."/".$folder_a."/".$folder_b] : $folder_b)."");
...
//--------------- Icon and image slide ------------------
        $replace = array("".(($img_user_id != "" and $img_user_id != "0") ? "<a href='".e_HTTP."user.php?id.".$img_user_id."' title='".MYGAL_L084." ".$img_user_name."'>".$img_user_name."</a>" : MYGAL_L085)."".(($img_user_id != "" and $img_user_id == "0") ? "<a href='javascript:window.location=\"mai\"+\"lto:\"+\"$img_user_mail[0]\"+\"@\"+\"$img_user_mail[1]\";self.close();'>".$img_user_name."</a>" : "")."",
					...
					"<a href='".e_SELF."?gallery=".$gallery."'>".($folder_name[$gallery] !="" ? $folder_name[$gallery] : "$gallery")."</a>",

					"".$info[0]."x".$info[1]."",

					"<a href='dload.php?file=$gallery/$value'>".MYGAL_L022."</a>",

					"<a id='thumb_$value' alt='".($img_title != "" ? "".$img_title."" : "".MYGAL_L027." ".$value."" )."'
					".($img_description !="" ? "title='".MYGAL_L037.": ".$img_description."'" : "")."
					...
					"".($pref['mygallery_comments']
					? "<a href='".e_PLUGIN."my_gallery/comments.php?comm_id=".$comm_id."".($comm_id=="add" ? "&img=".$gallery."/".$value."" : "")."' onclick=\"return hs.htmlExpand(this, { contentId: 'highslide-html', objectType: 'iframe', objectWidth: 700, objectHeight: 500} )\" class='highslide'>
					".MYGAL_L045."".$mydb->db_Count("comments", "(*)", "WHERE comment_item_id = '".$comm_id."' AND comment_type = 'my_gallery'")."
					</a>
				    <div class='highslide-html-content' id='highslide-html' style='width: 700px'>
				    	<div class='highslide-move' style='border: 0; height: 18px; padding: 2px; cursor: default'>
        ...
        $mg_hs_caption = str_replace($search, $replace, $MG_HIGHSLIDE_CAPTION);

		$replace[] = "<div class='highslide-caption' id='caption_$value'>".$mg_hs_caption."</div>";

        $text_gall .= str_replace($search, $replace, $MG_IMAGE);
...
//========= Page navigation =======================
	$text_gall .= "<div class='mygall_page_nav'> ";
	    ...
	    if ($page > 1) {
	        $backe = $page - 1;
	        $text_gall .= "<span class='mg_nav_back'><a href='".e_SELF."?gallery=".$gallery."&page=".$backe."'>&lt;</a></span>";
	         }

	    for ($page_list=1; $page_list<(($l/$foto_in_page)+1); $page_list++) {

	        if ($page != $page_list) {
	        $text_gall .= "<span class='mg_nav_page_link'><a href='".e_SELF."?gallery=".$gallery."&page=".$page_list."'>".$page_list."</a></span>";
		       } else {
		         $text_gall .= "<span class='mg_nav_page'>".$page_list."</span>";
	 	       }
	     }

	     $text_gall .= "<span class='mg_nav_info'>".($k_start+1)."-".$k_in_page."/".$l."</span>";

	    if ($page < ($page_list-1)) {
	    $next = $page+1;
	    $text_gall .= "<span class='mg_nav_next'><a href='".e_SELF."?gallery=".$gallery."&page=".$next."'>&gt;</a></span>";
	    }
	$text_gall .= "</div>";
...
if ($gallery == $folder and $user_id != "" and $action != "comments") {
    ...
    if ($mydb->db_Select("my_gallery", "*", "img_user like '".$user_id."%' and img_status = 'public' ORDER BY img_id DESC")) {
      while($row = $mydb->db_Fetch()) {
		...
		$text_gall .= "<table>";
		$text_gall .= "<th colspan='".$foto_columns."'>".MYGAL_L082." ".$img_user_name."</th>";

		define("e_PAGETITLE", "".$gallery_name." - ".MYGAL_L082." - ".$img_user_name."");
		...
		if ($k<$l_b) {
			...
			if ($mydb->db_Select("my_gallery", "*", "img_name = '".$value."'")) {
		        while($row = $mydb->db_Fetch()) {
		            $comm_id = $row['img_id'];
		            $img_title = $row['img_title'];
		            $img_description = $row['img_description'];
		...
		list($folder_0, $folder_a, $folder_b, $file) = explode("/", $value);
        ...
        $replace = array("".(($img_user_id != "" and $img_user_id != "0") ? "<a href='".e_HTTP."user.php?id.".$img_user_id."' title='".MYGAL_L084." ".$img_user_name."'>".$img_user_name."</a>" : MYGAL_L085)."".(($img_user_id != "" and $img_user_id == "0") ? "<a href='javascript:window.location=\"mai\"+\"lto:\"+\"$img_user_mail[0]\"+\"@\"+\"$img_user_mail[1]\";self.close();'>".$img_user_name."</a>" : "")."",
					...
					"<a id='thumb_".$file."' alt='".($img_title != "" ? "".$img_title."" : "".$value."" )."'
					".($img_description !="" ? "title='".MYGAL_L037.": ".$img_description."'" : "")."
					".(file_exists("".$folder_0."/".$folder_a."/".$folder_b."/tv_".$file."")
					? "href='image.php?file=".$folder_0."/".$folder_a."/".$folder_b."/tv_".$file."'"
					: "href='foto.php?img=".$value."&h=".$foto_view_height."&w=".$foto_view_width."'")."
					class='highslide' onclick=\"return hs.expand(this, { captionId: 'caption_$value' } )\">
					".(file_exists("".$folder_0."/".$folder_a."/".$folder_b."/tn_".$file."")
					? "<img src='image.php?file=".$folder_0."/".$folder_a."/".$folder_b."/tn_".$file."' />"
					: "<img src='".$tn_scr."?img=".$value."&h=".$foto_icon_height."&w=".$foto_icon_width."' />")."
					</a>",
	        ...
	        $text_gall .= str_replace($search, $replace, $MG_IMAGE_UG);
		}
		...
		$text_gall .= "<div class='mygall_page_nav'>";
		    ...
		    if ($page > 1) {
		        $backe = $page - 1;
		        $text_gall .= "<span class='mg_nav_back'><a href='".e_SELF."?user=$user_id&page=$backe'>&lt;</a></span>";
		         }
		    for ($page_list=1; $page_list<(($l/$foto_in_page)+1); $page_list++) {
		        if ($page != $page_list) {
		        $text_gall .= "<span class='mg_nav_page_link'><a href='".e_SELF."?user=".$user_id."&page=".$page_list."'>".$page_list."</a></span>";
		        } else {
		         $text_gall .= "<span class='mg_nav_page'>".$page_list."</span>";
		        }
		     }
		    ...
		    if ($page < ($page_list-1)) {
		    $next = $page+1;
		    $text_gall .= "<span class='mg_nav_next'><a href='".e_SELF."?user=$user_id&page=$next'>&gt;</a></span>";
		    }
		$text_gall .= "</div>";
    }
}
...
if (!$pref['upload_enabled'] || $pref['upload_class'] == 255) {
	$text_gall .= "";
		...
		$text_gall .= "<div class='mg_upload_button' style='text-align:center;'>
			".(getperms("P")
				? "<a href='".e_PLUGIN."my_gallery/admin_config.php?upload'>".MYGAL_L074." (".$mydb->db_Count("my_gallery", "(*)", "WHERE img_status = 'upload'").")</a>"
				: "<a href='".e_PLUGIN."my_gallery/upload.php'>".MYGAL_L058."</a>")."</div>"; }
...
if ($action == "comments") {
    ...
    $cobj -> compose_comment("my_gallery", "comment", $comm_id, "", $img_title, $showrate=FALSE);
    } else {
