...
$CUSTOMPAGES = "forum.php forum_post.php forum_viewforum.php forum_viewtopic.php user.php submitcontent.php download.php links.php comment.php stats.php usersettings.php documentation";
