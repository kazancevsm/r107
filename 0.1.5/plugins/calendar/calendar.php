...
|
|     $URL: https://e107.svn.sourceforge.net/svnroot/e107/trunk/e107_0.7/e107_plugins/calendar/calendar.php $
|     $Revision: 12098 $
...
{
    header("Location: " . e_PLUGIN . "calendar/event.php?" . $_POST['enter_new_val']);
	exit;
} 
if (isset($_POST['doit']))
{
