...
$e_plug_table	= "gallery"; //This is set to the table name you have decided to use.
$reply_location	= e_PLUGIN."gallery/gallery.php?comm_id=$nid"; //This is set to the location you'd like the user to return to after replying to a comment.
$db_table		= "gallery"; //This is the name of your plugins database table.
